...
# K-NN Classifier is non linear classifier which gives us non linear boundary between the regions 
# predicting the test set results
y_pred = classifier.predict(x_test)

# making the confusion matrix
# this matrix gives us the number of the correct and the incorrect predictions
# the matrix output gives 64 , 4 , 3 , 29 
# the number of the correct predictions = 64 + 29 = 93
# the number of the incorrect predictions = 3+4 = 7
